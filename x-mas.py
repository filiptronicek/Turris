...
#
# author: Vojtech Myslivec <vojtech@xmyslivec.cz>, Filip Troníček <filip.tronicek@seznam.cz>
# inspired by:
...
# list of Turris leds
leds = [ 'pwr', 'lan1', 'lan2', 'lan3', 'lan4', 'wan', 'wifi', 'lan' ]
...
while True:
    ...
    if random_led != "lan":
        if "lan" in random_led:
            call(["rainbow", random_led, random_state])
        else:
            print("rainbow", random_led, random_state)
            print("rainbow", random_led, random_color)
            call([ "rainbow", random_led, random_state ])
